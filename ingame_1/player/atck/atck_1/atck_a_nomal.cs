...
public class atck_a_nomal : MonoBehaviour
{
    ...
    IEnumerator hit()
    {
        transform.position = new Vector3(atck_target_temp.target_obj.transform.position.x, atck_target_temp.target_obj.transform.position.y, atck_target_temp.target_obj.transform.position.z);
